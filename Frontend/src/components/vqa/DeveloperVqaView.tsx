  ...
  return <div className="space-y-6">
    ...
    {report && <>
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <MetricCard title="First Response Audio" value={milliseconds(report.summary.averageFirstResponseAudioMs)} description={`${report.summary.measuredResponseCalls} measured calls`} Icon={Gauge} tone="bg-amber-50 text-amber-600" />
      </div>
