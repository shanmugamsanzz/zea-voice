  ...
  return <div className="space-y-6">
    ...
    {report && <>
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <MetricCard label="AI Summary Coverage" value={`${report.summary.summaryCoverage}%`} helper={`${report.summary.summarizedCalls} summarized · ${report.summary.summaryFailedCalls} failed`} Icon={Sparkles} tone="bg-violet-50 text-violet-600" />
        <MetricCard label="Follow-Up Required" value={report.summary.followUpRequiredCalls} helper={`${report.summary.negativeRate}% negative sentiment`} Icon={ShieldAlert} tone="bg-rose-50 text-rose-600" />
      </div>
