...
Agents require one tenant-configured technical-failure message. Ordinary
conversation, ambiguity, unsupported information, and workflow guidance are
generated by the single context-aware LLM rather than static recovery wording.
